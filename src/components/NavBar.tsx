...
export function NavBar() {
  ...
  return (
    <nav className="safe-bottom shrink-0 border-t border-edge/80 bg-void/80 px-2 backdrop-blur-2xl lg:hidden">
          ...
          return (
            <li key={href} className="relative flex-1">
              ...
              <Link
                ...
                className={`flex flex-col items-center gap-1 rounded-xl py-2.5 text-[0.6rem] uppercase tracking-[0.12em] transition-colors ${
