...
function LoginForm() {
  ...
  return (
    <form onSubmit={submit} className="surface-card w-full max-w-sm space-y-4 p-6 text-center sm:p-8">
      ...
      <div>
        ...
        <p className="mt-1 text-[0.76rem] text-mist">Sign in to continue</p>
      </div>
