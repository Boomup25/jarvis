...
export function InsightRow({ insight }: { insight: Insight }) {
  ...
  return (
    <li className="flex items-start gap-3 rounded-xl border border-edge bg-panel/50 px-3 py-2.5">
  ...
  return (
    <li>
      <Link
        ...
        className="group flex items-center gap-3 rounded-xl border border-edge bg-panel/50 px-3 py-3 transition-colors hover:border-arc/40"
      >
...
export function StatTile({
  ...
  return (
    <div className="rounded-xl border border-edge bg-panel/50 px-2.5 py-3">
      ...
      <p className="mt-1 text-[0.6rem] uppercase leading-tight tracking-wider text-mist">{label}</p>
...
export function SectionTitle({
  ...
  return (
    <div className="flex items-baseline justify-between">
      <h2 className="text-[0.7rem] uppercase tracking-[0.18em] text-mist">{children}</h2>
      {action}
    </div>
  );
}
